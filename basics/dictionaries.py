...
# Метод pop удаляет пару по ключу и возврашает значение
popped = dict.pop(3)
print(dict) # {1:"a", 2:"b", 4:"e"}
print(popped) # d

dict.pop("Не сушествуюший ключ") # KeyError


# Метод popitem удаляет и возврашает последнюю пару
print(dict1.popitem())
print(dict1)