"=================Логическое==============="
# логические операторы - выражение,True, если правда и False,если не правда
...
"=======================Boolean Tye=================" 
# Булевые тип данных - имеет всего 2 значения True и  False
bool(1) #True
bool(0) #False
bool(-277) #True
...
"=====================None=================="
# None - это тип данных с одним None, который используется для оюозначения пустых значений или отсутствия значения
bool(None) #False
bool('None') #True
...
Anastasiya Tuzikova, [10/6/22 11:43]
if условие1:
    тело1
...
"============Тернарные операторы======================"
# Усоровия в одну строку
тело if условие else тело2
